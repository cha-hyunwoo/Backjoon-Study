...
처음에 Arrays.sort로 그냥 써봤는데 역시나 정렬이 제대로 안되고 Arrays.sort에 조건문처럼 람다식쓰는 방법이 기억나서 사용함
문자열 중복인거 처리할때 문자열 비교는 ==으로 안되고 equals를 사용해야 했음

### 제출 일자

2026년 1월 7일 14:09:29
