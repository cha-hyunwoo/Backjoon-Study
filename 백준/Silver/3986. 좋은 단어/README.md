...
A와 B를 서로 다른 두 종류의 괄호로 가정하고 스택으로 접근했음

ABBA처럼 열린 괄호가 먼저 닫히는 구조는 스택에서 제거되어 '좋은 단어'가 되지만, ABAB처럼 괄호의 짝이 서로 교차하는 경우에는 스택이 비어있지 않아 '나쁜 단어'로 판별됨

### 제출 일자

2026년 2월 13일 10:34:43
