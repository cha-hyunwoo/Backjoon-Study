...
처음에 '모든 로프를 사용해야 할 필요는 없으며, 임의로 몇 개의 로프를 골라서 사용해도 된다.'이 조건을 보지 않고 풀어서 틀렸음

정렬한 후 작은 것부터 본인보다 크거나 같은 것을 더해서 최대값을 확인해 나가는 방법으로 해결했음.

(문제를 똑바로 읽자..!)

### 제출 일자

2026년 2월 8일 18:34:27
